...
<script>
    ...
    export default {
        ...
        mixins: [ appMixin, slugMixin, redirectionMixin ],
        data () {
            return {
                slugsCreated: [],
                urlsRedirection: [],
        ...
        methods: {
            ...
            async refreshRedirections () {
                ...
                for ( const appLocale of this.appLocales ) {
                    urlRedirection = ''

                    this.redirections.some(redirection => {
                        const scapeCondition = redirection.slug_origin === appLocale.slug
            ...
            async getRedirectionsWithoutPaginate (  ) {
                ...
                for ( const appLocale of this.appLocales ) {
                    filters.slugs_origin.push(appLocale.slug)
                }
